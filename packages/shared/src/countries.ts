/** ISO 3166-1 alpha-2 codes + common names, for the nationality picker (EXPANSION.md Section 1.1). */
...
export const COUNTRIES: Country[] = [
  ...
  { code: "BG", name: "Bulgaria" }, { code: "BF", name: "Burkina Faso" }, { code: "KH", name: "Cambodia" },
  ...
  { code: "MT", name: "Malta" }, { code: "MR", name: "Mauritania" }, { code: "MX", name: "Mexico" },
